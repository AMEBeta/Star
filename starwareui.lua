...
local Colors = {
	PageTextPressed = Color3fromRGB(239,191,4);
	PageBackgroundPressed = Color3fromRGB(239,191,4);
	PageBorderPressed = Color3fromRGB(0, 0, 0);
	PageTextHover = Color3fromRGB(239,191,4);
	PageBackgroundHover = Color3fromRGB(0, 0, 0);
	PageTextIdle = Color3fromRGB(0, 0, 0);
	PageBackgroundIdle = Color3fromRGB(239,191,4);
	PageBorderIdle = Color3fromRGB(239,191,4);
	ElementBackground = Color3fromRGB(239,191,4);
}
